package com.jaahanava.studentmanagementsystem;
...
public class StudentManagementSystemApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// Student student1 = new Student("Jaahanava", "Joshi", "jaahanavajoshi@gmail.com");
		// studentRepository.save(student1);

		// Student student2 = new Student("Virat", "Kohli", "viratkohli@gmail.com");
		// studentRepository.save(student2);

		// Student student3 = new Student("Narendra", "Modi", "narendramodi@gmail.com");
